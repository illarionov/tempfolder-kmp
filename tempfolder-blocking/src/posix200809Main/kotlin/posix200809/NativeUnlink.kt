...
internal fun unlinkFile(dirfd: TempfolderPosixFileDescriptor, path: PosixPathString): Int = unlink(dirfd, path, false)
...
private fun unlink(
    ...
    val resultCode = memScoped {
        val pathBytes: CPointer<ByteVarOf<Byte>> = allocNullTerminatedPath(path)
